...
# 🎮 HELL GALAXY — Community Edition

**Arcade space shooter, complete standalone build, ready to play.**
...
HELL GALAXY is a fast-paced arcade space shooter in which a lone pilot fights through overrun sectors of the galaxy, blasting waves of alien hosts and towering multi-phase bosses. Resources collected during runs feed into persistent ship upgrades, letting each new attempt start stronger than the last. This Community Edition is a standalone build of the complete game, delivered as a self-contained package with all content included. No storefront or client software is required — the game is ready to play immediately and runs fully offline.

Players looking for an offline, standalone arcade space shooter that runs well on modest hardware.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2513490/2ed8dc7f76067b581bf2672899640e97972e84ef/ss_2ed8dc7f76067b581bf2672899640e97972e84ef.1920x1080.jpg?t=1786554006" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2513490/ss_6388d8c542ddbd6ad76721e2b0942671ddbc5d03.1920x1080.jpg?t=1786554006" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2513490/fd15d1b2927c845525551639f51692ed6cdee76e/ss_fd15d1b2927c845525551639f51692ed6cdee76e.1920x1080.jpg?t=1786554006" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🚀 **Fast-Paced Combat** — Dodge-heavy arcade dogfights against dense swarms of alien enemies.
- 👾 **Boss Encounters** — Each sector concludes with a large multi-phase boss fight.
- 🛠️ **Ship Upgrades** — Spend collected resources on weapons, hulls, and systems between runs.
- 💀 **Roguelite Progression** — Permadeath runs paired with persistent meta-upgrades across attempts.
- 🌌 **Varied Sectors** — Distinct visual themes and enemy sets across the galaxy map.
- 🎮 **Controller Support** — Playable with keyboard or gamepad, with remappable controls.
- 📦 **Self-Contained Package** — All game content included in one installer; no additional software required.

- **Compression:** Lossless
- **Install Time:** ~1 minute on SSD, ~3 minutes on HDD
- **Recoding:** none
- **Selective Download:** Not applicable — the package contains the complete game
...
| **Processor** | Intel Core i3 2.0 GHz or AMD equivalent | Intel Core i5 3.0 GHz or AMD equivalent |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | DirectX 10 compatible GPU with 1 GB VRAM | NVIDIA GeForce GTX 750 Ti or better, 2 GB VRAM |
| **Storage** | 1 GB available space | 1 GB available space on SSD |
| **Additional** | DirectX 11, keyboard or controller | Gamepad recommended for full experience |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\HELLGALAXY\Saved`
